...
void main(void) {
  ...
  // Single direct-projection path (see header note #3). instancePositions and
  // instancePositions64Low are [0,0,0] for MeshTextureLayer, so this projects
  // the mesh vertex pos directly, carrying its fp64 low part. Correct for
