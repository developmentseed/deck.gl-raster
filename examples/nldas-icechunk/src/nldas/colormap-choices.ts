...
/** Shape constraint for a single colormap choice. */
...
/**
 * Shortlist of colormap options appropriate for near-surface air temperature.
 * Order drives the dropdown order in the control panel.
 */
